...
namespace TinkerforgeNodes {
    public class Helpers {
        ...
        public static void AddMqttOutputToLogger(LoggingConfiguration configuration, MqttClient logConnection) {
            var mqttLogger = new MqttLoggerNlogTarget();
            mqttLogger.BrokerConnection = logConnection;
            mqttLogger.Layout = _mqttLayout;
            mqttLogger.Topic = "tevux/logs";
            configuration.AddRuleForAllLevels(mqttLogger);
        }
    }
}
